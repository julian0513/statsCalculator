...
function calculateMean(numbers) {
    fetch('http://localhost:8080/api/statistics/mean', {
        method: 'POST',
        headers: {
...
function calculateMedian(numbers) {
    fetch('http://localhost:8080/api/statistics/median', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateRange(numbers) {
    fetch('http://localhost:8080/api/statistics/range', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateStandardDeviation(numbers) {
    fetch('http://localhost:8080/api/statistics/standard-deviation', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateSampleVariance(numbers) {
    fetch('http://localhost:8080/api/statistics/sample-variance', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
