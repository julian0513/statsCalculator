...
function calculateMean(numbers) {
    fetch('https://statscalculator-7dd4949c606a.herokuapp.com/api/statistics/mean', { // Updated URL to fetch from backend host, not local host 8080 for testing
        method: 'POST',
        headers: {
...
function calculateMedian(numbers) {
    fetch('https://statscalculator-7dd4949c606a.herokuapp.com/api/statistics/median', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateRange(numbers) {
    fetch('https://statscalculator-7dd4949c606a.herokuapp.com/api/statistics/range', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateStandardDeviation(numbers) {
    fetch('https://statscalculator-7dd4949c606a.herokuapp.com/api/statistics/standard-deviation', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateSampleVariance(numbers) {
    fetch('https://statscalculator-7dd4949c606a.herokuapp.com/api/statistics/sample-variance', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
