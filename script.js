...
function calculateMean(numbers) {
    fetch('https://julianStatsCalculator.us-east-1.elasticbeanstalk.com/api/statistics/mean', { // Updated URL to fetch from backend host, not local host 8080 for testing
        method: 'POST',
        headers: {
...
function calculateMedian(numbers) {
    fetch('https://julianStatsCalculator.us-east-1.elasticbeanstalk.com/api/statistics/median', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateRange(numbers) {
    fetch('https://julianStatsCalculator.us-east-1.elasticbeanstalk.com/api/statistics/range', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateStandardDeviation(numbers) {
    fetch('https://julianStatsCalculator.us-east-1.elasticbeanstalk.com/api/statistics/standard-deviation', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function calculateSampleVariance(numbers) {
    fetch('https://julianStatsCalculator.us-east-1.elasticbeanstalk.com/api/statistics/sample-variance', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
